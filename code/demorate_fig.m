...
y = 1 + sin(x.*(pi/12) + pi);
subplot(4,1,1)
area(x,y,"FaceColor",chainsaw{2}, "FaceAlpha",0.5,"EdgeColor","none")
ax = gca;
...
subplot(4,1,2)
area(x,yr,"FaceColor",chainsaw{2}, "FaceAlpha",0.5,"EdgeColor","none")
ax = gca;
...
subplot(4,1,3)
area(x,yrp,"FaceColor",chainsaw{4}, "FaceAlpha",0.5,"EdgeColor","none")
hold on
xz = [0:0.1:3, 3.*ones(1,180), 3:-0.1:0.1];
yrz = 0.75*cos(xz.*(pi/6));
area(x,yrz,"FaceColor",chainsaw{3}, "FaceAlpha",0.5,"EdgeColor","none")
yrm = 0.2.*cos(x.*(pi/12));
area(x,yrm,"FaceColor",chainsaw{1}, "FaceAlpha",0.5,"EdgeColor","none")
...
subplot(4,1,4)
area(x',yrb', "FaceColor",chainsaw{5},"FaceAlpha",0.5,"EdgeColor","none")

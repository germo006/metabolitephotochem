function [coef, res, r2, yhat, sdr, ccoef, bcmean] = expregress1(x,y,sy,a0)
% EXPREGRESS1 is designed to optimize an exponential regression by
...
%       a0: parameter guesses. A vector where the a0(1) is the
%       pre-exponential factor and a0(2) is the rate coefficient
%   OUTPUTS:
%       coef:   optimized coefficients, in the same order as a0
